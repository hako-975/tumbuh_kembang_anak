                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($user as $du): ?>
                                            <tr>
                                                ...
                                                <td class="text-center align-middle"><?= $du['username']; ?></td>
                                                <td class="text-center align-middle"><?= ucwords($du['jabatan']); ?></td>
                                                <td class="text-center align-middle"><?= $du['nama']; ?></td>
                                                <td class="text-center align-middle"><?= date('d-M-Y, H:i:s', strtotime($du['dibuat_pada']));; ?></td>
